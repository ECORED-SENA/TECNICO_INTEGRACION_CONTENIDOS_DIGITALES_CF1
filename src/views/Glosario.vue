    ...
    .glosario__letra-item.mb-2(v-for="letra in orderedData" :key="'letra-'+letra.letra")
      ...
      .glosario__letra-item__texto
        p.mb-3(v-for="termino in letra.terminos")
          strong •  
          strong(v-html="termino.termHTML || termino.termino")
          strong : 
          span(v-html="termino.significado")
</template>

<script>
import BannerInterno from '../../node_modules/ecored-base-pkg/src/components/plantilla/BannerInterno'
import plantillaMixins from '../../node_modules/ecored-base-pkg/src/mixins/plantillaMixins'
export default {
  name: 'Glosario',
  components: {
    BannerInterno,
