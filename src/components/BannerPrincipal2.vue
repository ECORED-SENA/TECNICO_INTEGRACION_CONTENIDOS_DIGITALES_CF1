  ...
  .container.tarjeta(
    ...
    .row.banner-principal__row
      ...
      .d-none.d-lg-block.col-lg-5.px-0.banner-principal__img
        .contenedor-imagenes
          .imagen_flotante.imagen_flotante_1: img(src="@/assets/curso/float1.svg")
          .imagen_flotante.imagen_flotante_2: img(src="@/assets/curso/float2.svg")
          .imagen_flotante.imagen_flotante_3: img(src="@/assets/curso/float3.svg")
          .imagen_flotante.imagen_flotante_4: img(src="@/assets/curso/float4.svg")
